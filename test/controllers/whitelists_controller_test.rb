...
class WhitelistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create whitelist" do
    assert_difference('Whitelist.count') do
      post whitelists_url, params: { whitelist: { hostnames: @whitelist.hostnames, mailbox_id: @whitelist.mailbox_id } }
    end
  ...
  test "should update whitelist" do
    patch whitelist_url(@whitelist), params: { whitelist: { hostnames: @whitelist.hostnames, mailbox_id: @whitelist.mailbox_id } }
