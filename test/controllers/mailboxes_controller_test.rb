...
class MailboxesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mailbox" do
    assert_difference('Mailbox.count') do
      post mailboxes_url, params: { mailbox: { access_token: @mailbox.access_token, api_key: @mailbox.api_key, email: @mailbox.email } }
    end
  ...
  test "should update mailbox" do
    patch mailbox_url(@mailbox), params: { mailbox: { access_token: @mailbox.access_token, api_key: @mailbox.api_key, email: @mailbox.email } }
